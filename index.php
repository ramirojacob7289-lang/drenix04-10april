...
_Hasync.push(['Histats.start', '1,5019665,4,0,0,0,00010000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?5019665&101" alt="hit counter code" border="0"></a></noscript>
<!-- Histats.com  END  -->
...
<div id="templatemo_wrapper">
	<div id="templatemo_header">
        <div id="site_title">
            <h1><a href="#">Connect Template</a></h1>
        </div>
  ...
  <div id="templatemo_main">
    	...
    	<div class="content_box">
        	<div class="content_title content_ctf">
        	  <h2>Welcome to Connect Template</h2></div>
            <div class="content">
                ...
                <p>Connect Template is one-page layout using JavaScripts scrolling function. This template can be applied for any purpose. Credit goes to <a href="http://www.publicdomainpictures.net" target="_blank">Public Domain Pictures</a> for photos used in this template. Validate <a href="http://validator.w3.org/check?uri=referer" rel="nofollow"><strong>XHTML</strong></a> &amp; <a href="http://jigsaw.w3.org/css-validator/check/referer" rel="nofollow"><strong>CSS</strong></a>. </p>
                <p>Sed sit amet dignissim nisl. Curabitur iaculis sit amet magna eu lacinia. Aliquam eleifend lorem et convallis placerat. Vestibulum non mi orci. Integer purus magna, fringilla ut leo vitae, imperdiet mattis dui.</p>
		    <div class="cleaner h30"></div>
                <div class="col_w340 float_l">
                  <h3>Web Design Tips</h3>
                    <ul class="tmo_list">
                        <li>Curabitur a odio ut tortor lobortis ornare</li>
                        <li>Etiam vitae velit sed sapien consectetur blandit</li>
                        <li>Suspendisse quis nibh eget arcu sodales</li>
                        <li>Pellentesque hendrerit est elementum iaculis sagittis</li>
    			...
    			<div class="col_w340 float_r">
                    <h3>Testimonial</h3>
                    <blockquote>
                    <p>Vivamus viverra euismod velit, ac bibendum magna vestibulum id. Pellentesque luctus arcu at orci imperdiet, in venenatis risus vehicula. Etiam vulputate et nisl eu porta.</p>
                    <cite>Ronald - <span>Vice President</span></cite></blockquote>
          		</div>
                
                <div class="cleaner"></div>
            </div>
            
            <div class="content_bottom content_cb"><a href="#aboutus" class="gototop">About Us</a></div>
		</div> 
    	...
    	<div class="content_box">
            ...
            <div class="content">
                ...
                <p><em>Etiam vitae velit sed sapien consectetur blandit. Nulla fermentum odio ac ipsum sollicitudin, eget aliquet mi venenatis. Aliquam ut augue sollicitudin, elementum tortor eu, laoreet tellus.</em></p>
...
<div class="post_box float_r">
            ...
            <div class="content_bottom content_cb"><a href="#portfolio" class="gototop">Portfolio</a></div>
		</div>   
    	...
    	<div class="content_box">
            ...
            <div class="content_bottom content_cb"><a href="#contactus" class="gototop">Contact</a></div>
		</div> 
